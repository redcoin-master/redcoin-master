...
#if defined(NDEBUG)
# error "RedCoin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 10000 * 60 * 60 *3650; // 8 hours
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
   ...
   if(pindexBest->nHeight == 1)
    {
        nSubsidy = 510000000 * COIN;	// 1 billion coins, that all pow coins
